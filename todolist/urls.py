...
urlpatterns = [
     ...
     path('todolist/delete/<int:task_id>/', views.delete_item_view, name="delete_item"),
     ...
     path('todolist/edit/task/create/<int:task_id>/', views.edit_task_create, name="edit_task_create"),
]
